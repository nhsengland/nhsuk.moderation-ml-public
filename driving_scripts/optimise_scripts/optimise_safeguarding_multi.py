## This is an older iteration of the optimise script, before a more elegant refactoring of code to functionalise more parts, and before tests were introducted. Readers should look to the optimise_safeguarding.py file instead, and 
## simply change the 'multiclass' argument (and change log_all_multiclass_metrics to log_all_metrics towards the end of the script) to switch between binary and multiclass safeguarding models.
...
EXPERIMENT_NAME = "at_safeguarding_multi_recall_moredata"
...
for embeddings_model in embeddings_models:
    for classifier_name in classifier_names:
        ...
        this_one.assessor.log_all_multiclass_metrics(
            display_labels=["no risk", "low risk", "high risk"], run=run
        )
