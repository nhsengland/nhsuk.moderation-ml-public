...
deployment.download_model(model_name="on-mink", version=1, target_dir=MODEL_DIR)
deployment.download_model(
    model_name="BAAI-bge-base-en", version=2, target_dir=MODEL_DIR
)
...
deployment = ManagedOnlineDeployment(
    ...
    model=Model_entity(name="uninformative-classical-model", path=MODEL_DIR),
